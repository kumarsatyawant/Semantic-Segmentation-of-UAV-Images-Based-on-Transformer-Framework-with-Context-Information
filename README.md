...
Fig. 1. The schematic representation of the encoder-decoder-based network. Overview of the proposed architecture. Encoder network consists of linear projection, transformer encoder and Token Spatial Information Fusion (TSIF) modules. Decoder network progressively upsamples the encoder network output.
